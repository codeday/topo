...
import { Options, useToasts as useToastsNative } from 'react-toast-notifications';
...
export function useToasts() {
  ...
  return {
    addToast,
    info: (children: React.ReactNode, opts?: Options | undefined) => addToast(children, { appearance: 'info', ...opts }),
    success: (children: React.ReactNode, opts?: Options | undefined) => addToast(children, { appearance: 'success', ...opts }),
    warning: (children: React.ReactNode, opts?: Options | undefined) => addToast(children, { appearance: 'warning', ...opts }),
    error: (children: React.ReactNode, opts?: Options | undefined) => addToast(children, { appearance: 'error', ...opts }),
    ...builtins,
  };
}
